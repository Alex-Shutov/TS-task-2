...
export class UserSettingsModule {
	...
	private readonly  _mapMethods : Map<UserSettingOptions,(x:string)=>boolean> = new Map<UserSettingOptions, (x: string) => boolean>()
	...
	public changeUserSettings(option: UserSettingOptions, argsForChangeFunction: string): boolean {
		return this._mapMethods.get(option)(argsForChangeFunction);
	}
}
